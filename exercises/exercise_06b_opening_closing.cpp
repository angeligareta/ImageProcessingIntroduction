...
int main(int argc, char **argv) {
    ...
    cv::Mat output = Utils::closing(Utils::opening(input, kernel), kernel);
    ...
    cv::morphologyEx(input, expected_output, cv::MORPH_OPEN, kernel);
    cv::morphologyEx(expected_output, expected_output, cv::MORPH_CLOSE, kernel);
    cv::imwrite("./data/letter_opening_closing_opencv.png", expected_output);
